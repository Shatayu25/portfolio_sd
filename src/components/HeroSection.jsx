    ...
    <section className="flex min-h-screen flex-col items-center justify-center bg-slate-500">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex items-center justify-center p-1 md:p-2 lg:p-4">
          <HiPlay />
          <span className="animate-move-in-left font-roboto text-sm text-slate-200 sm:text-lg md:text-xl lg:text-xl">
            Front-end Engineer
          </span>
        </div>
      </div>
      <div className="mt-4  flex items-center gap-2 sm:mt-4 sm:gap-4 md:mt-8 md:gap-8 lg:mt-10 lg:gap-10">
        <div className="flex animate-move-in-right gap-2 rounded-full border-[0.5px] border-black bg-slate-100 p-1 sm:gap-4 sm:p-2 md:gap-4 md:p-2 lg:gap-4 lg:p-4">
        ...
        <a
          className="flex animate-move-in-left items-center gap-1 rounded-full border-[0.5px] border-black bg-red-500 p-[4px] font-roboto text-black transition-all duration-200 hover:bg-red-600 sm:gap-1 sm:p-[6px] md:gap-1 md:p-2 lg:gap-2 lg:p-4"
          target="_blank"
          rel="noreferrer"
