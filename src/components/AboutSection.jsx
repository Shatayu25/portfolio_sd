function AboutSection() {
  return (
    <section className="bg-zinc-950 py-20">
      <div className="mx-auto flex max-w-7xl flex-col gap-10 p-10">
        ...
        <div className="font-cascadia flex w-[400px] flex-col gap-4">
          <p>
            &rarr; A Full-stack developer focused on building complete,
            responsive web applications. I care about writing clean code,
            designing interfaces that make sense, and building reliable backends
